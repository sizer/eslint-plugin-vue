...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      category: undefined,
      url: 'https://github.com/vuejs/eslint-plugin-vue/blob/v5.0.0/docs/rules/html-comment-indent.md'
    },
    fixable: 'whitespace',
    schema: [
      {
  ...
  create (context) {
    ...
    return commentParser.defineVisitor(context, {}, (comment) => {
      const baseIndentText = getLineIndentText(comment.node.loc.start.line)
      let endLine
      if (comment.value) {
